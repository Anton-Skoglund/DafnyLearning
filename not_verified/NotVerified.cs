// Dafny program NotVerified.dfy compiled into C#
...
// Command-line arguments: test NotVerified.dfy
// NotVerified.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    public static void __Test____Main__(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _0_success = true;
      if (!(_0_success)) {
        throw new Dafny.HaltException("NotVerified.dfy(1,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test failures occurred: see above.
