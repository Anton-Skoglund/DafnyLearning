// Dafny program abs.dfy compiled into C#
...
// Command-line arguments: test abs.dfy
// abs.dfy
...
namespace _module {
  ...
  public partial class __default {
    ...
    {
      BigInteger x_k = BigInteger.Zero;
      x_k = x;
      if ((x_k).Sign == -1) {
        x_k = (x_k) * (new BigInteger(-1));
      }
      return x_k;
    }
    public static void __Test____Main__(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      ...
      _0_success = true;
      if (!(_0_success)) {
        throw new Dafny.HaltException("abs.dfy(3,0): " + Dafny.Sequence<Dafny.Rune>.UnicodeFromString(@"Test failures occurred: see above.
