// Dafny program MultiReturns.dfy compiled into C#
...
// Command-line arguments: build MultiReturns.dfy
// MultiReturns.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static void MultipleReturns(BigInteger x, BigInteger y, out BigInteger more, out BigInteger less)
    {
      more = BigInteger.Zero;
      less = BigInteger.Zero;
      more = (x) + (y);
      less = (x) - (y);
    }
  }
